...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_53802a13abf2d7_66467111',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53802a13abf2d7_66467111')) {function content_53802a13abf2d7_66467111($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
...
<a href="zamowienia.php?id=1093"><< prev</a> <a href="zamowienia.php?id=1095"> next>></a>   
		...
		<input type="hidden" id="y2" name="kadr" value="164"> 
		</form>
		
		<div class="thumbnail"  style="width: 100%; float: left;">
			<a href="#"><img src="../galeria/panele/_137439926527090.jpg" class="" alt="" id="photo"></a>
		<div class="caption">_137439926527090.jpg id=86 szer_min900 wys_min216</div> 
			</div>
			<div>
			<div class="col-lg-7">

			  id obrazu = 86 plik = _137439926527090.jpg<br>
			  szer_orginału =7382 wys_orginału =1772<br>
			  katalog ../galeria/Panele<br>
			  kategoria = 23			
			</div>
			</div>
			<div class="col-lg-5">
			<h3>zamówienie = 1094</h3>

                        <h4 class="text-danger">login Felix-k7</h4>
			ip      77.255.199.2<br>
			email  kasia34@autograf.pl<br>
